...
public static class L10n
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Wyłączone: ekran Maca pojawia się dopiero, gdy kursor wejdzie na niego z ekranu Maca."] = "Off: the Mac display appears only when the pointer moves onto it from the Mac screen.",
